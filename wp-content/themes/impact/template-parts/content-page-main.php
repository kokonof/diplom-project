			...
			<div class="row gy-4 mt-5">
				...
				<div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
					<div class="icon-box">
						...
						<h4 class="title"><a class="stretched-link">  Ласкаво просимо до нашої шкільної спільноти!</a></h4>
					</div>
				</div><!--End Icon Box -->
				...
				<div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
					<div class="icon-box">
						...
						<h4 class="title"><a class="stretched-link">Відкрийте світ можливостей</a></h4>
					</div>
				</div><!--End Icon Box -->
				...
				<div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
					<div class="icon-box">
						...
						<h4 class="title"><a class="stretched-link">Розвивайся разом з нами</a></h4>
					</div>
				</div><!--End Icon Box -->
				...
				<div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
					<div class="icon-box">
						...
						<h4 class="title"><a class="stretched-link">Досліджуйте, творіть, зростайте</a></h4>
					</div>
				</div><!--End Icon Box -->

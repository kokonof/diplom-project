...
= 7.0.1 =
* Fixed warnings when the initial metadata is incorrect (missing width or height) and bypass summary
* Fixed the SVGs preview in admin listing when the image metadata is missing width or height
